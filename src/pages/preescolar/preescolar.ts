...
/**
 * Generated class for the PreescolarPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-preescolar',
  templateUrl: 'preescolar.html',
})
export class PreescolarPage {

  constructor(public navCtrl: NavController, public navParams: NavParams) {
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad PreescolarPage');
  }
